...
vim.api.nvim_create_autocmd('TermClose', {
  callback = function(ev)
    ...
    if success and vim.api.nvim_buf_is_valid(ev.buf) then
...
set_key('<leader>jO', function()
  vim.lsp.buf.code_action { context = { diagnostics = {}, only = { 'source.organizeImports' } } }
end, 'Organize imports (source action)')
...
-- Format
set_key('<leader>mf', function()
  vim.lsp.buf.format { async = true, name = 'jdtls' }
end, 'Format with JDTLS')
